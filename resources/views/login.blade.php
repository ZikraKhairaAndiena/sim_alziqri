                    ...
                    <form class="card-body cardbody-color p-lg-5" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                id="password" name="password" placeholder="Masukkan password" minlength="5" required>
                        ...
                        <div id="emailHelp" class="form-text text-center mb-5 text-dark"><a href="{{ route('register') }}"
                                class="text-dark fw-bold">Belum punya akun? Daftar</a>
                        </div>
                    </form>
                </div>
