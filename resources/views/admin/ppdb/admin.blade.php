                                    ...
                                    @foreach ($ppdbs as $index => $item)
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                ...
                                                <a href="{{ route('admin.ppdb.cetak', $item->id) }}"class="btn btn-danger btn-sm"
                                                    title="Cetak Bukti Pendaftaran" target="_blank"><i
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item {{ $ppdbs->onFirstPage() ? 'disabled' : '' }}">
                                            <a class="page-link" href="{{ $ppdbs->previousPageUrl() }}"
                                                aria-label="Previous">
