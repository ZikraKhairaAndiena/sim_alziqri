            ...
            <div class="card-body">
                <form action="{{ route('orang_tua.ppdb.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="agama" class="form-select @error('agama') is-invalid @enderror" required>
                                ...
                                <option value="kong_hu_cu" {{ old('agama') == 'kong_hu_cu' ? 'selected' : '' }}>Konghucu
                                </option>
                            </select>
                            @error('agama')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Bertempat Tinggal Pada <span
                                    class="text-danger">*</span></label>
                            <select name="tmp_tinggal" class="form-select @error('tmp_tinggal') is-invalid @enderror"
                                required>
                                <option value="">-- Pilih --</option>
                                <option value="orang_tua" {{ old('tmp_tinggal') == 'orang_tua' ? 'selected' : '' }}>Orang
                                    Tua</option>
                                ...
                                <option value="saudara" {{ old('tmp_tinggal') == 'saudara' ? 'selected' : '' }}>Saudara
                                </option>
                            </select>
                            @error('tmp_tinggal')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    {{-- Upload Akte --}}
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Upload Akte Kelahiran<span
                                class="text-danger">*</span></label>
                        <input type="file" name="foto_akte"
                            class="form-control @error('foto_akte') is-invalid @enderror" id="foto_akte">
                        <small class="form-text text-muted">Format file: jpeg, png, jpg, gif. Maksimal ukuran 2 MB.</small>
                        @error('foto_akte')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
