            ...
            <div class="card-body">
                <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            name="nama_siswa"class="form-control @error('nama_siswa') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="tmp_lahir"
                                ...
                                value="{{ old('tmp_lahir', $siswa->tmp_lahir) }}" placeholder="Masukkan tempat lahir"
                                required>
                            @error('tmp_lahir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="agama" class="form-select @error('agama') is-invalid @enderror" required>
                                ...
                                <option value="kong_hu_cu"
                                    {{ old('agama', $siswa->agama) == 'kong_hu_cu' ? 'selected' : '' }}>Kong Hu Cu</option>
                            </select>
                            @error('agama')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="suku_bangsa"
                                class="form-control @error('suku_bangsa') is-invalid @enderror"
                                value="{{ old('suku_bangsa', $siswa->suku_bangsa) }}">
                            @error('suku_bangsa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="anak_ke" min="0"
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Jumlah Saudara Kandung<span
                                    class="text-danger">*</span></label>
                            <input type="number" name="jmlh_saudara_kandung" min="0"
                                class="form-control @error('jmlh_saudara_kandung') is-invalid @enderror"
                                value="{{ old('jmlh_saudara_kandung', $siswa->jmlh_saudara_kandung) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="tmp_tinggal" class="form-select @error('tmp_tinggal') is-invalid @enderror"
                                required>
                                <option value="orang_tua"
                                    {{ old('tmp_tinggal', $siswa->tmp_tinggal) == 'orang_tua' ? 'selected' : '' }}>Orang
                                    Tua</option>
                                <option value="wali"
                                    {{ old('tmp_tinggal', $siswa->tmp_tinggal) == 'wali' ? 'selected' : '' }}>Wali</option>
                                <option value="nenek"
                                    {{ old('tmp_tinggal', $siswa->tmp_tinggal) == 'nenek' ? 'selected' : '' }}>Nenek
                                </option>
                                <option value="saudara"
                                    {{ old('tmp_tinggal', $siswa->tmp_tinggal) == 'saudara' ? 'selected' : '' }}>Saudara
                                </option>
                            </select>
                            @error('tmp_tinggal')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Alamat Tempat Tinggal<span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="no_nik"
                                class="form-control @error('no_nik') is-invalid @enderror"value="{{ old('no_nik', $siswa->no_nik) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">No Kartu Keluarga<span
                                    class="text-danger">*</span></label>
                            <input type="text" name="no_kk"
                                class="form-control @error('no_kk') is-invalid @enderror"
                                value="{{ old('no_kk', $siswa->no_kk) }}" placeholder="Masukkan No KK" required>
                            @error('no_kk')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="no_akte" class="form-control @error('no_akte') is-invalid @enderror"
                            value="{{ old('no_akte', $siswa->no_akte) }}" placeholder="Masukkan No Akte" required>
                        @error('no_akte')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Nama Orang Tua / Wali<span
                                class="text-danger">*</span></label>
                        <input type="text" name="nama_wali"
                            class="form-control @error('nama_wali') is-invalid @enderror"
                            value="{{ old('nama_wali', $siswa->nama_wali) }}" placeholder="Masukkan nama wali" required>
                        @error('nama_wali')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">No Telepon Orang Tua / Wali<span
                                class="text-danger">*</span></label>
                        {{-- <small class="text-muted d-block mb-1">Gunakan format 628..., contoh: 628123456789</small> --}}
                        <input type="text" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror"
                            value="{{ old('no_telp', $siswa->no_telp) }}" placeholder="Masukkan nomor telepon" required>
                        @error('no_telp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($siswa->foto)
                            <img src="{{ asset('img/' . $siswa->foto) }}" alt="Foto Siswa" width="100"
                                class="mb-2"><br>
                        @endif
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Gambar Kartu Keluarga (KK)<span
                                class="text-danger">*</span></label><br>
                        @if ($siswa->foto_kk)
                            <img src="{{ asset('img/' . $siswa->foto_kk) }}" alt="Gambar KK" width="100"
                                class="mb-2"><br>
                        @endif
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Gambar Akta Kelahiran<span
                                class="text-danger">*</span></label><br>
                        @if ($siswa->foto_akte)
                            <img src="{{ asset('img/' . $siswa->foto_akte) }}" alt="Gambar Akte" width="100"
                                class="mb-2"><br>
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            ...
                            <option value="tidak_aktif"
                                {{ old('status', $siswa->status) == 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
