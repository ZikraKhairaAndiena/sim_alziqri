                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="text-center">
                                {{-- Foto siswa --}}
                                @if ($siswa->foto)
                                    <img src="{{ asset('img/' . $siswa->foto) }}" alt="Foto {{ $siswa->nama_siswa }}"
                                        class="img-thumbnail mb-3" style="max-width: 200px;">
                                @else
                                    <img src="{{ asset('images/default-user.png') }}" alt="Default Foto"
                                        class="img-thumbnail mb-3" style="max-width: 200px;">
                                @endif
                            </div>
                                        ...
                                        <td>
                                            @if ($siswa->foto_kk)
                                                <img src="{{ asset('img/' . $siswa->foto_kk) }}"
                                                    alt="{{ $siswa->nama_siswa }}" width="200" class="img-thumbnail">
                                            @else
