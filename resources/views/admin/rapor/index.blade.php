                    ...
                    <div class="card-body">
                        <h2 class="card-title text-center fw-bold mb-4">Data rapor</h4>
                            <div class="table-responsive">
                                <a href="{{ route('admin.rapor.create') }}" class="btn btn-success btn-sm mb-3">Tambah
                                    Rapor</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-nowrap text-center">
                                                    <div class="btn-group" role="group">
                                                        <a href="{{ route('admin.rapor.show', $rapor->id) }}"
                                                            class="btn btn-info btn-sm me-1" title="Lihat Detail">
                                                            <i class='mdi mdi-eye'></i>
                                                        </a>
                                                        <a href="{{ route('admin.rapor.edit', $rapor->id) }}"
                                                            class="btn btn-warning btn-sm me-1" title="Edit Data"><i
                                                                class='mdi mdi-pencil'></i></a>
                                                        <form action="{{ route('admin.rapor.destroy', $rapor->id) }}"
                                                        ...
                                                        <a href="{{ route('admin.rapor.cetak', $rapor->id) }}"
                                                            class="btn btn-sm btn-danger ms-1" target="_blank"
                                                            title="Cetak PDF"><i class="mdi mdi-file-pdf-box"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @empty
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $rapors->onFirstPage() ? 'disabled' : '' }}">
                                                <a class="page-link" href="{{ $rapors->previousPageUrl() }}"
                                                    aria-label="Previous">
